...
| Task | Plugin |
|------|--------|
| DCF, comps, valuation | `financial-analysis` |
| Pitch books, mandates | `investment-banking` |
| Earnings summaries, models | `equity-research` |
| LBO, deal sourcing | `private-equity` |
| Portfolio analysis, reporting | `wealth-management` |
| Real-time market data | `lseg`, `spglobal` |
| Excel/Word/PowerPoint automation | `claude-in-office` |
